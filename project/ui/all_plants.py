...
class Ui_AllPlantsWindow(object):
    def setupUi(self, AllPlantsWindow):
        ...
        AllPlantsWindow.resize(425, 350)
        AllPlantsWindow.setMinimumSize(QSize(425, 350))
        AllPlantsWindow.setMaximumSize(QSize(425, 350))
        palette = QPalette()
        ...
        self.select_plant.setGeometry(QRect(10, 90, 256, 251))
        ...
        self.species_label = QLabel(AllPlantsWindow)
        self.species_label.setObjectName(u"species_label")
        self.species_label.setGeometry(QRect(280, 250, 141, 16))
        self.sort_by_label = QLabel(AllPlantsWindow)
        self.sort_by_label.setObjectName(u"sort_by_label")
        self.sort_by_label.setGeometry(QRect(140, 40, 151, 16))
    ...
    def retranslateUi(self, AllPlantsWindow):
        ...
        self.species_label.setText(QCoreApplication.translate("AllPlantsWindow", u"Species", None))
